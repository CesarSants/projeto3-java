...
public class Venda implements Persistente {
	...
	public void adicionarProduto(Produto produto, Integer quantidade) {
		validarStatus();
		validarEstoqueProduto(produto, quantidade);
	...
	private void validarEstoqueProduto(Produto produto, Integer quantidade) {
		if (produto.getEstoque() < quantidade) {
			throw new EstoqueInsuficienteException("Estoque insuficiente para o produto " + produto.getCodigo());
		}
	}
