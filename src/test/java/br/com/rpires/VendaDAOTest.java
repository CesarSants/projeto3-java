...
public class VendaDAOTest {
	...
	@Test
	public void validarEstoqueAposVenda() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException, DAOException {
	    String codigoVenda = "A12";
	    String codigoProduto = "A12";
	    Produto produto = cadastrarProduto(codigoProduto, BigDecimal.TEN);
	    ...
	    Produto produtoConsultado = produtoDao.consultar(codigoProduto);
	    assertEquals(8L, produtoConsultado.getEstoque().longValue());
	}

	@Test(expected = EstoqueInsuficienteException.class)
	public void tentarVenderProdutoSemEstoque() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException, DAOException {
	    String codigoVenda = "A13";
	    String codigoProduto = "A13";
	    Produto produto = cadastrarProduto(codigoProduto, BigDecimal.TEN);
	    produto.setEstoque(0L);
	    produtoDao.alterar(produto);
